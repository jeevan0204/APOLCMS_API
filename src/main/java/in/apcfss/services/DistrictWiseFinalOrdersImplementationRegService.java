...
public interface DistrictWiseFinalOrdersImplementationRegService {

	List<Map<String, Object>> getCASESLIST(Authentication authentication, HCCaseStatusAbstractReqBody abstractReqBody);
